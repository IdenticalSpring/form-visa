...
export const Step1Form = ({ data }: { data?: UserInfo }) => {
  ...
  <div className="grid gap-4 ">
    ...
    <FormItem label="Tên khác">
      ...
      />
      {errors.name_alias && (
        <p className="text-rose-500 text-sm mt-2">{errors.name_alias.message}</p>
      )}
    </FormItem>
    ...
    <FormItem label="Tình trạng hôn nhân">
      ...
      {errors.marital_status && (
        <p className="text-rose-500 text-sm mt-2">{errors.marital_status.message}</p>
      )}
    </FormItem>
    <FormItem label="Nơi sinh của vợ/chồng">
      ...
      {errors.husband_wife_pob && (
        <p className="text-rose-500 text-sm mt-2">{errors.husband_wife_pob.message}</p>
      )}
    </FormItem>
    <FormItem label="Đã có con?">
      ...
      {errors.is_has_kid && (
        <p className="text-rose-500 text-sm mt-2">{errors.is_has_kid.message}</p>
      )}
    </FormItem>
    <FormItem label="Quốc gia">
      ...
      {errors.country && (
        <p className="text-rose-500 text-sm mt-2">{errors.country.message}</p>
      )}
    </FormItem>
    <FormItem label="Quốc tịch">
      ...
      {errors.nationality && (
        <p className="text-rose-500 text-sm mt-2">{errors.nationality.message}</p>
      )}
    </FormItem>
    <FormItem
    ...
    >
      ...
      {errors.is_has_other_nationality && (
        <p className="text-rose-500 text-sm mt-2">{errors.is_has_other_nationality.message}</p>
      )}
    </FormItem>
    {watch("is_has_other_nationality") == 1 && (
      <FormItem label="Hãy cho biết quốc tịch gì?">
        ...
        {errors.other_nationality && (
          <p className="text-rose-500 text-sm mt-2">{errors.other_nationality.message}</p>
        )}
      </FormItem>
    )}
    <FormItem label="Địa chỉ ghi trên hộ khẩu?">
      ...
      {errors.address_on_paper && (
        <p className="text-rose-500 text-sm mt-2">{errors.address_on_paper.message}</p>
      )}
    </FormItem>
    <FormItem label="Địa chỉ nơi ở hiện tại?">
      ...
      {errors.current_address && (
        <p className="text-rose-500 text-sm mt-2">{errors.current_address.message}</p>
      )}
    </FormItem>
